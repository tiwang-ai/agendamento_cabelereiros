...
urlpatterns = [
    ...
    path('admin/', include([
        ...
        path('bot-config/', include([
            path('', bot_config_view, name='bot-config'),
            path('settings/', bot_settings_view, name='bot-settings'),
            ...
            path('instance/check/', check_instance_exists, name='check-instance-exists'),
        ])),
